...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p class="text">
            ...
            nombreuses societés de Fast Food bien connu (Le grand M et le petit Q) pendant de long mois, et avoir essuyé
            de multiples
            refus, il décida de créer sa propre chaîne de restaurants pour développer cette idée. C'est alors qu'il a
            ouvert le premier Bug
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p class="text">
            ...
            premier restaurant
            imagine, conçoit et critique les futurs plats de notre chaîne. Si nos produit ont un goût si particulier,
            c'est
            grâce à l'experience qu'il a accumulé durant toutes ces années dans les plus grands palaces
            français.</p>
    </div>
</div>
<hr>
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p class="text">
            ...
            Écosystèmes. Puis un jour, au détour d'un salon dédié aux insectes, il rencontre Damien et son projet fou,
            dès
            lors ils ne se sont plus quittés et depuis le premier jour de Bug Burger, c'est lui qui s'occupe et prend
            soin
